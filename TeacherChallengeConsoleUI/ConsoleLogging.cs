...
internal static class ConsoleLogging
{
    ...
    /// this method will pass a message to the user
    /// and will change the text color based on the status code
    /// </summary>
    /// <param name="alertMessage">Message to tell the user</param>
    /// <param name="statusCode">Status code for the type of alert - 
    /// Error = Red text something terrible happened,
    /// Success = Green text something good happened,   
